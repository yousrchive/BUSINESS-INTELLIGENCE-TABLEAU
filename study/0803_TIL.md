...
![image-2.png](https://github.com/yousrchive/tableau/blob/main/study/img/1st%20study/image-5.png?raw=true)
...
![image-2.png](https://github.com/yousrchive/tableau/blob/main/study/img/1st%20study/image-1.png?raw=true)
...
### 문제 풀이
 ...
 여기서는 계산된 필드를 만들 때, 행 단위로 만들 것인지 혹은 뷰에서 그때그때 Groupby 기준에 따라 달라지는 집계 함수로 만들 것인지를 구분하는 것이 필요합니다.
...
과연 가장 많이 주문한 사람들은 배송속도에 대해 만족했을까요? 
