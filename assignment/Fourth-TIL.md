...
> **🧞‍♀️ 오늘의 스터디는 지니와 함께합니다.** 초반은 힘들겠지만 마크 뒤 부분부터는 편한 마음으로 들을 수 있으니 화이팅 !!
...
제품 중분류별로 구분하되 매개변수로써 수익, 매출, 수량을 입력하면 저절로 각각 지표에 해당하는 그래프로 바뀌도록 설계하고자 해요.
 ...
 어떤 값이 각 지표의 평균보다 낮은 값을 갖고 있다면 색깔을 주황색으로, 그것보다 높다면 파란색으로 그라데이션으로 표시하고 싶어요. 단, 그 평균값은 각 지표별로 달라야 해요.
```